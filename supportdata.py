...
print()
plt.clf()
# Finn minimumsverdien i arrayet
...
# Finn maksimumsverdien i arrayet
...
total_samtaletid = np.sum(epoch_array)
antall_samtaler = np.size(epoch_array)
snitt_verdi = round(total_samtaletid/antall_samtaler)
